...
% wc ~ Beta(a, b)
wc_a = 6; % w_a ~ Normal(1, _5)T(0_5, inf)
...
c_mu_mu = 1; c_mu_sigma = 2;   % Fixed hyper prior values
...
cf_mu_mu = 1; cf_mu_sigma = 2;     % Fixed hyper prior values
...
wp_a_mu    = 1; wp_a_sigma = 1;
wp_b_mu    = 1; wp_b_sigma = 1;
