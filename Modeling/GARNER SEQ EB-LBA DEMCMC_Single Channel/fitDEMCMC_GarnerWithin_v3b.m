...
parpool('local', 8)
 fn = 'GarnerWithin_Bri_Sat_singleChannel.mat'; % Fit both simultaneously
%fn = 'GarnerSeparable_Bri_Sat_singleChannel.mat';
% fn = 'GarnerBoxcar_Line_Sat_singleChannel.mat';

%% Load an organize data
 [model, data, n, subnums] = loadData;                 % Integral
% [model, data, n, subnums] = loadDataSep;            % Separable Bri/Sat
%[model, data, n, subnums] = loadDataBoxcar;          % Box car
