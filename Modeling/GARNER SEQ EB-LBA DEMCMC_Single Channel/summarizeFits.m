...
for i = 1%:numel(experiments)
    if exist(fullfile(fitfolder, sprintf('%ssingleChannel.mat', experiments{i})), 'file') == 2
        load(fullfile(fitfolder, sprintf('%ssingleChannel.mat', experiments{i})), 'model', 'data', 'theta', 'weight', 'n')
