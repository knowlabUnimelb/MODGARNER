...
experiment = 1; % 1 = Garner Within, 2 = Separable (Sat/Bri), 3 = Boxcar (Line/Sat), 4 = simulation
condition = 0; % 0 = all, 1 = first 4 subs, 2 = last 4 subs

%% Datafile information
% Folders
mainfolder = 'C:\Users\littled\Dropbox\Work\2017 Garner\Garner SEQ EB-LBA DEMCMC';
...
switch experiment
    ...
    case 1
        ...
        if condition == 0
            ...
            subIdxs = 1:8; 
            fitfn  = 'GarnerWithin_Bri_Sat_meancentered.mat'; % Experiment 1 - Integral Brightness
        elseif condition == 1
            mdsfn = 'mds_Brightness - Constrained.dat'; 
            subIdxs = 1:4; 
            fitfn  = 'GarnerWithin_Brightness_meancentered.mat'; % Experiment 1 - Integral Brightness
        elseif condition == 2
...
%             fitfn = 'GarnerWithin_Saturation.mat';
    ...
    case 2
        ...
        if condition == 0
            ...
            subIdxs = 1:8;
            fitfn  = 'GarnerSeparable_Bri_Sat_meancentered.mat'; % Experiment 1 - Integral Brightness
        elseif condition == 1
             subIdxs = 1:4;
            fitfn = 'GarnerSeparable_Bri_EBexponential.mat'; % Sep Experiment 1 - Brightness
        elseif condition == 2
             subIdxs = 5:8;
            fitfn = 'GarnerSeparable_Sat_EBexponential.mat'; % Sep Experiment 1 - Brightness
        end
    case 3
        ...
        if condition == 0
            mdsfn = {'mds_Separable.dat','mds_Separable.dat','mds_Separable.dat','mds_Separable.dat',...
                'mds_Separable.dat','mds_Separable.dat','mds_Separable.dat','mds_Separable.dat'};
            subIdxs = 1:8;
            fitfn  = 'GarnerBoxcar_Line_Sat_meancentered.mat'; % Experiment 1 - Integral Brightness            
        elseif condition == 1
             subIdxs = 1:4;
            fitfn = 'GarnerBoxcar_Line_EBexponential_BroadestPriors.mat';
        else
             subIdxs = 5:8;
            fitfn = 'GarnerBoxcar_EBexponential.mat';
        end
    case 4
