...
fitfns = {'GarnerWithin_Brightness_meancentered.mat', 'GarnerWithin_Saturation_meancentered.mat',...
          'GarnerSeparable_Brightness_meancentered.mat', 'GarnerSeparable_Saturation_meancentered.mat',...
          'GarnerBoxcar_Line_meancentered.mat', 'GarnerBoxcar_Saturation_meancentered.mat'};
...
% Plot function
colors = [.5 0 0; .5 .5 0; 0 .5 0; 0 .5 .5; .5 0 .5; 0 0 .5];
xidx = fidx; 
...
hold on
    ...
    hm1 = plot(xval(2), mean(a(:,2)), ' ^k', 'MarkerSize', 5, 'MarkerFaceColor', 'k');
figHand1(fidx) = h1(1);
...
set(gca, 'YLim', [0 .5], 'XLim', [0 7], 'XTick', sort([(1:6) - .15, (1:6) + .15]), 'XTickLabel', {'w', 'w_{cr}', 'w', 'w_{cr}', 'w', 'w_{cr}', 'w', 'w_{cr}', 'w', 'w_{cr}', 'w', 'w_{cr}'})
legend(figHand1, 'Integral - Brightness', 'Integral - Saturation', 'Exp 1: Separable - Brightness', 'Exp 1: Separable - Saturation', 'Exp 2: Boxcars - Line', 'Exp 2: Boxcars - Saturation')
end
...
hold on
    ...
    hm1 = plot(xval(2), mean(C(:,2)), ' ^k', 'MarkerSize', 5, 'MarkerFaceColor', 'k');
figHand2(fidx) = h1(1);
...
ylabel('Posterior Value')
title('Sensitivity')
set(gca, 'YLim', [0 5], 'XLim', [0 7], 'XTick', sort([(1:6) - .15, (1:6) + .15]), 'XTickLabel', {'c', 'c_{f}', 'c', 'c_{f}', 'c', 'c_{f}', 'c', 'c_{f}', 'c', 'c_{f}', 'c', 'c_{f}'})
legend(figHand2, 'Integral - Brightness', 'Integral - Saturation', 'Exp 1: Separable - Brightness', 'Exp 1: Separable - Saturation', 'Exp 2: Boxcars - Line', 'Exp 2: Boxcars - Saturation')
end
...
xs = 1:1.5:9;
xidx = xs(fidx); 
xval = [xidx - .3, xidx - .15, xidx, xidx + .15, xidx + .3];
...
ylabel('Posterior Value')
title('Category Bias')
set(gca, 'YLim', [0 1], 'XLim', [0 10], 'XTick', sort([(xs) - .3, (xs) - .15, (xs), (xs) + .15, (xs) + .3]),...
    'XTickLabel', {'b_{1}', 'b_{2}', 'b_{3}', 'b_{4}', 'b_{5}', 'b_{1}', 'b_{2}', 'b_{3}', 'b_{4}', 'b_{5}', 'b_{1}', 'b_{2}', 'b_{3}', 'b_{4}', 'b_{5}', 'b_{1}', 'b_{2}', 'b_{3}', 'b_{4}', 'b_{5}', 'b_{1}', 'b_{2}', 'b_{3}', 'b_{4}', 'b_{5}', 'b_{1}', 'b_{2}', 'b_{3}', 'b_{4}', 'b_{5}'})
legend(figHand3, 'Integral - Brightness', 'Integral - Saturation', 'Exp 1: Separable - Brightness', 'Exp 1: Separable - Saturation', 'Exp 2: Boxcars - Line', 'Exp 2: Boxcars - Saturation')
end
...
if fidx == 6
legend(figHand4, 'Integral - Brightness', 'Integral - Saturation', 'Exp 1: Separable - Brightness', 'Exp 1: Separable - Saturation', 'Exp 2: Boxcars - Line', 'Exp 2: Boxcars - Saturation')
end
...
if fidx == 6
legend(figHand5, 'Integral - Brightness', 'Integral - Saturation', 'Exp 1: Separable - Brightness', 'Exp 1: Separable - Saturation', 'Exp 2: Boxcars - Line', 'Exp 2: Boxcars - Saturation')
end
end
