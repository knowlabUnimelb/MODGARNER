...
% subIdxs = 1:4;
subIdxs = 5:8;        
dataloc = 'C:\Users\littled\Dropbox\work\2017 Garner\MODIFIED GARNER BOXCAR\data';

%% Get Grand mean
alldata =[];
for sidx = subIdxs
    sub = subs{sidx};
    fn = sprintf('Garner_BOXCAR_sub%s_ordered_tagged_msec.dat', sub); % File name sequence data, tagged with outliers
