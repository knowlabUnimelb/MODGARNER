...
outputfile = sprintf('GARNER_SEPARABLE_%03d_%02d_s%02d.dat', subject, condition, session);
tmpfile = sprintf('tmp_GARNER_SEPARABLE_%03d_%02d_s%02d.dat', subject, condition, session);
